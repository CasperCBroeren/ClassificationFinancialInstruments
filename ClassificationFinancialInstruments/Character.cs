namespace ClassificationFinancialInstruments
{
    ...
    internal record ClassificationGroup(char Charachter, string Explanation, Classification[] Attribute1, Classification[] Attribute2, Classification[] Attribute3, Classification[] Attribute4);
}
